 ...
 * @returns 経度、緯度
 */
export const getCurrentPosition = (mapConfig) => {
...
export function getBoundingBox(lat, lng, radiusKm = 10) {
...
export function getMapViewDistanceKm(map) {
...
export function updateMarkersByCenter(allMarker, hideMarkers, map) {
    // 現在の中心を取得
